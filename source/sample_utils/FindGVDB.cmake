...
if ( GVDB_ROOT_DIR )
	...
	#-------- Locate Header files
        set ( OK_H "0" )
	_FIND_FILE ( GVDB_HEADERS GVDB_INCLUDE_DIR "gvdb.h" "gvdb.h" "gvdb.h" OK_H )
	if ( OK_H EQUAL 1 ) 
    ...
    #-------- Locate Library	
        set ( OK_DLL "0" )	
        set ( OK_LIB "0" )	
	_FIND_FILE ( LIST_DLL GVDB_LIB_DIR "libgvdb.dll" "libgvdb.so" "libgvdb.dylib" OK_DLL )	
  	_FIND_FILE ( LIST_LIB GVDB_LIB_DIR "libgvdb.lib" "libgvdb.so" "libgvdb.dylib" OK_LIB )	        
	...
	if ( (OK_PTX EQUAL 2) AND (OK_GLSL EQUAL 3) ) 
